...
<head>
    ...
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ url('public') }}/assets/images/icons/icon.png">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <table class="table table-cart table-mobile col-md-15">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="product-col">
                                                <div class="product">
                                                    <figure class="product-media">
                                                        <a href="#">
                                                            <img src="{{url("public", $cart->foto)}}" alt="Product image">
                                                        </a>
                                                    </figure>
                                            ...
                                            <td class="price-col-md-10">Rp.{{ number_format($cart->harga )}}</td>
                                            <td class="quantity-col">
                                                <div class="cart-product-quantity">
                                                    <input type="number" class="form-control" value="1" min="1" max="10" step="1" data-decimals="0" required>
                                                </div><!-- End .cart-product-quantity -->
                                            </td>
                                            <td class="total-col">Rp.{{ number_format($cart->harga )}}</td>
                                            <td><a href="{{ url('checkout',$cart->id) }}" class="btn btn-outline-primary-2 btn-order ml-5 mr-0">CHECKOUT</a></td>
                                            <td>
                                ...
                                <div class="cart-bottom">
                                    ...
                                    <a href="{{ url('shop') }}" class="btn btn-outline-dark-2"><span>CONTINUE SHOPPING</span><i class="icon-refresh"></i></a>
                                </div><!-- End .cart-bottom -->
                            </div><!-- End .col-lg-9 -->
                        </div><!-- End .row -->
                    </div><!-- End .container -->
